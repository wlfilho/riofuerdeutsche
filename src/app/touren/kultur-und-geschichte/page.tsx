...
const kulturPlaces = [
    ...
    },
    {
        ...
        tip: "Schau vorher auf der Website, welche Ausstellung gerade läuft, denn das CCBB holt regelmäßig internationale Blockbuster-Ausstellungen nach Rio. Die Tickets sind kostenlos, aber begrenzt.",
    ...
    },
    {
        ...
        tip: 'Bestelle den traditionellen \u201eCafé com Pastel de Nata\u201c und nimm dir Zeit, die Details der Einrichtung zu bewundern, denn jeder Spiegel und jedes Ornament hat über 130 Jahre Geschichte.',
    ...
    },
    {
        ...
        tip: "Kombiniere den Besuch mit einem Spaziergang durch den Aterro do Flamengo, denn die Gartenanlage ist die größte urbane Parklandschaft der Welt und wurde vom gleichen Landschaftsarchitekten entworfen.",
    ...
    },
    {
        ...
        tip: "Nimm die Fähre von der Praça XV nach Niterói, denn die Überfahrt dauert nur 20 Minuten und bietet eine fantastische Aussicht auf Rio. Das MAC ist dann nur eine kurze Busfahrt entfernt.",
...
export default async function KulturUndGeschichtePage() {
    ...
    const anfrageWhatsappHref = `${whatsappLink}?text=${encodeURIComponent('Hallo! Ich interessiere mich für die Kultur & Geschichte Tour.')}`
