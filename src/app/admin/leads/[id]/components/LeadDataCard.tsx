      ...
      <div className="px-5 py-1">
        ...
        <Row label="PAX">
          <span className="inline-flex items-center gap-1">
            ...
            {lead.pax} {lead.pax === 1 ? 'pessoa' : 'pessoas'}
          </span>
        </Row>

        {lead.days !== null && (
          <Row label="Dias">{lead.days} {lead.days === 1 ? 'dia' : 'dias'}</Row>
        )}
        ...
        <Row label="Criado em">{formatDate(lead.created_at)}</Row>

        {(lead.estimated_min !== null || lead.estimated_max !== null) && (
          <Row label="Estimativa">
            {lead.estimated_min !== null && lead.estimated_max !== null
              ? `entre €${lead.estimated_min} e €${lead.estimated_max}`
              : `€${lead.estimated_min ?? lead.estimated_max}`}
          </Row>
        )}

        <Row label="Conversa Claude">
