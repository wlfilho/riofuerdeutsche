...
const quickInfo = [
    { key: "Dauer", value: "2–3 Stunden" },
    { key: "Sprache", value: "Deutsch" },
    { key: "Abholung", value: "Am Hotel" },
    { key: "Eintritt", value: "Kostenlos" },
];
            ...
            <div className="flex flex-col min-h-screen bg-white selection:bg-[#22a262] selection:text-white font-sans">
                ...
                <main className="flex-grow pt-24 lg:pt-28">
                    <div className="max-w-7xl mx-auto px-5 lg:px-8">
                        ...
                        {/* ── Breadcrumb ──────────────────────────────── */}
                        <nav
                            className="flex items-center flex-wrap gap-y-1 text-sm text-gray-400 py-5 mb-1"
                        ...
                        >
                            ...
                            <ChevronRight className="w-3.5 h-3.5 mx-1.5 shrink-0" />
                            <span className="text-gray-700 font-medium">Rocinha</span>
                        </nav>

                        {/* ── Two-column block: gallery + product card ─── */}
                        <div className="grid md:grid-cols-[1fr_280px] gap-6 mb-16">

                            {/* ── Gallery ──────────────────────────────── */}
                            <div className="flex flex-col gap-2">
                                {/* Main photo */}
                                <div className="relative w-full rounded-2xl overflow-hidden aspect-[16/10] bg-gray-100">
                                    <Image
                                ...
                                <div className="grid grid-cols-2 gap-2">
                                    <div className="relative rounded-xl overflow-hidden aspect-[16/9] bg-gray-100">
                                        <Image
                                            ...
                                            alt="Favela Tour Rocinha — Blick auf die Gemeinschaft"
                                            fill
                                    ...
                                    <div className="relative rounded-xl overflow-hidden aspect-[16/9] bg-gray-100">
                                        <Image
                                            ...
                                            alt="Infografik Rocinha — Zahlen und Fakten"
                                            fill
                                            className="object-cover hover:scale-105 transition-transform duration-300 cursor-pointer"
                                            loading="lazy"
                                        />
                            ...
                            <div className="md:sticky md:top-4 h-fit">
                                <div className="border border-gray-200 rounded-2xl overflow-hidden shadow-sm bg-white">
                                    ...
                                    <div className="px-5 pt-5 pb-4 border-b border-gray-100">
                                        <p className="text-[11px] font-bold tracking-widest uppercase text-[#22a262] mb-2">
                                            Favela Tour · Privat
                                        </p>
                                        <h1 className="text-lg font-bold text-gray-900 leading-tight mb-2">
                                            Rocinha mit Will — auf Deutsch
                                        </h1>
                                        <p className="text-sm text-gray-500 leading-relaxed">
                                            Ein respektvoller Einblick in die größte Favela Brasiliens — authentisch, sicher, persönlich.
                                        </p>
                                    </div>

                                    {/* Quick info table */}
                                    <div className="px-5 py-1">
                                        {quickInfo.map(({ key, value }, i) => (
                                            <div
                                                key={key}
                                                className={`flex items-center justify-between py-3 text-sm ${i < quickInfo.length - 1 ? "border-b border-gray-100" : ""}`}
                                            >
                                            ...
                                            {includes.map((item) => (
                                                <div key={item} className="flex items-center gap-2">
                                                    <span className="w-4 h-4 rounded-full bg-[#d1fae5] flex items-center justify-center shrink-0">
                                                        <span className="text-[#2D6A4F] text-[10px] font-bold">✓</span>
                                                    </span>
                                    ...
                                    <div className="px-5 pb-5 border-t border-gray-100 pt-4 space-y-2">
                                        ...
                                        <Link
                                            href="/kontakt"
                                            className="w-full flex items-center justify-center gap-2 px-4 py-3 border border-gray-300 text-gray-700 rounded-xl font-medium text-sm hover:border-gray-400 hover:bg-gray-50 transition-colors"
                                        >
                                            <Mail className="w-4 h-4" />
                                            Per E-Mail anfragen
                                        </Link>

                                        <div className="flex items-center justify-center gap-1.5 pt-1 text-gray-400 text-xs">
                    ...
                    {/* ── Informational content — full width ──────────── */}

                    {/* Praktische Infos */}
                    <section className="py-16 lg:py-20 bg-gray-50 border-t border-gray-100">
                        <div className="max-w-7xl mx-auto px-5 lg:px-8">
                            <FadeIn direction="up">
                                <h2 className="text-xs font-bold tracking-widest uppercase text-[#22a262] mb-8">
                                    Praktische Infos auf einen Blick
                                </h2>
                            </FadeIn>
                            <div className="grid grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-5">

                                <FadeIn delay={0} direction="up" className="bg-white border border-gray-100 rounded-2xl p-5 flex flex-col gap-3 hover:border-[#22a262]/30 hover:shadow-sm transition-all duration-300">
                                ...
                                <FadeIn delay={0.05} direction="up" className="bg-white border border-gray-100 rounded-2xl p-5 flex flex-col gap-3 hover:border-[#22a262]/30 hover:shadow-sm transition-all duration-300">
                                ...
                                <FadeIn delay={0.1} direction="up" className="bg-white border border-gray-100 rounded-2xl p-5 flex flex-col gap-3 hover:border-[#22a262]/30 hover:shadow-sm transition-all duration-300">
                                ...
                                <FadeIn delay={0.15} direction="up" className="bg-white border border-[#22a262]/20 rounded-2xl p-5 flex flex-col gap-3 hover:border-[#22a262]/50 hover:shadow-sm transition-all duration-300">
                                    <span className="text-2xl" role="img" aria-label="Handschlag">🤝</span>
                                    <div>
                                        <p className="text-[11px] font-bold tracking-widest uppercase text-[#22a262] mb-1">Mit Will</p>
                                        <p className="text-gray-900 font-semibold text-[15px] leading-snug">Einzige Art, wie du wirklich eintauchst</p>
                                    </div>
                                </FadeIn>

                                <FadeIn delay={0.2} direction="up" className="bg-white border border-gray-100 rounded-2xl p-5 flex flex-col gap-3 hover:border-[#22a262]/30 hover:shadow-sm transition-all duration-300">
                                ...
                                <FadeIn delay={0.25} direction="up" className="bg-white border border-[#22a262]/20 rounded-2xl p-5 flex flex-col gap-3 hover:border-[#22a262]/50 hover:shadow-sm transition-all duration-300">
                                    <span className="text-2xl" role="img" aria-label="Sprechen">🗣️</span>
                                    <div>
                                        <p className="text-[11px] font-bold tracking-widest uppercase text-[#22a262] mb-1">Sprache</p>
                            ...
                            <FadeIn direction="up" className="mb-10">
                                <div className="max-w-[800px] mx-auto">
                                    <h2 className="text-3xl lg:text-4xl font-heading font-bold text-gray-900 leading-tight">
                                        Geschichte &amp;{" "}
                                        <span className="text-[#22a262]">Wissenswertes</span>
                                    </h2>
                                </div>
                            </FadeIn>
                        ...
                        <div className="max-w-7xl mx-auto px-5 lg:px-8">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                ...
                                <FadeIn delay={0} direction="up" className="flex">
                                    ...
                                    >
                                        <div className="relative h-48 overflow-hidden">
                                            <Image src="/images/cristo-bg.webp" alt="Christus Erlöser auf dem Corcovado in Rio de Janeiro" fill className="object-cover group-hover:scale-105 transition-transform duration-500" />
                                            <span className="absolute top-3 right-3 bg-white/90 backdrop-blur-sm px-2.5 py-0.5 rounded-full text-[9px] font-bold text-[#22a262] uppercase tracking-wider">Klassiker</span>
                                        </div>
                                        <div className="p-5 flex flex-col flex-grow">
                                            <h3 className="text-lg font-bold font-heading text-gray-900 mb-2">Christus Erlöser</h3>
                                            <p className="text-gray-500 text-sm leading-relaxed flex-grow">Vom Gipfel des Corcovado siehst du die Rocinha von oben — ein völlig anderer Blickwinkel auf denselben Ort.</p>
                                            <div className="flex items-center gap-1.5 text-sm font-bold text-[#22a262] mt-4">
                                ...
                                <FadeIn delay={0.08} direction="up" className="flex">
                                    ...
                                    >
                                        <div className="relative h-48 overflow-hidden">
                                            <Image src="/images/santa-teresa.webp" alt="Santa Teresa — das Künstlerviertel von Rio de Janeiro" fill className="object-cover group-hover:scale-105 transition-transform duration-500" />
                                            <span className="absolute top-3 right-3 bg-white/90 backdrop-blur-sm px-2.5 py-0.5 rounded-full text-[9px] font-bold text-[#22a262] uppercase tracking-wider">Kultur</span>
                                        </div>
                                        <div className="p-5 flex flex-col flex-grow">
                                            <h3 className="text-lg font-bold font-heading text-gray-900 mb-2">Santa Teresa</h3>
                                            <p className="text-gray-500 text-sm leading-relaxed flex-grow">Das Künstlerviertel über der Stadt — Straßenkunst, alte Villen, Bars und eine Energie, die an kein anderes Viertel Rios erinnert.</p>
                                            <div className="flex items-center gap-1.5 text-sm font-bold text-[#22a262] mt-4">
                                                Mehr erfahren <ArrowRight className="w-4 h-4 transition-transform group-hover:translate-x-1" />
                                            </div>
                                        </div>
                                ...
                                <FadeIn delay={0.16} direction="up" className="flex">
                                    ...
                                    >
                                        <div className="relative h-48 overflow-hidden">
                                            <Image src="/images/zuckerhut-pao-de-acucar-01.webp" alt="Zuckerhut — Pão de Açúcar in Rio de Janeiro" fill className="object-cover group-hover:scale-105 transition-transform duration-500" />
                                            <span className="absolute top-3 right-3 bg-white/90 backdrop-blur-sm px-2.5 py-0.5 rounded-full text-[9px] font-bold text-[#22a262] uppercase tracking-wider">Aussicht</span>
                                        </div>
                                        <div className="p-5 flex flex-col flex-grow">
                                            <h3 className="text-lg font-bold font-heading text-gray-900 mb-2">Zuckerhut</h3>
                                            <p className="text-gray-500 text-sm leading-relaxed flex-grow">Zwei Seilbahnen, 396 Meter Höhe — und vom Gipfel aus siehst du die ganze Zona Sul auf einmal, von Ipanema bis zur Guanabara-Bucht.</p>
                                            <div className="flex items-center gap-1.5 text-sm font-bold text-[#22a262] mt-4">
                                                Mehr erfahren <ArrowRight className="w-4 h-4 transition-transform group-hover:translate-x-1" />
                                            </div>
                                        </div>
